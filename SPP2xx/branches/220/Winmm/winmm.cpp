...
#else
extern NAKED UINT  __declspec(dllexport) joyGetPosEx(UINT uJoyID, LPJOYINFOEX pji) {  __asm jmp dword ptr   pjoyGetPosEx}
//extern NAKED UINT  __declspec(dllexport) joyGetDevCapsA(UINT uJoyID, LPJOYCAPS pjc, UINT cbjc) {  __asm jmp dword ptr   pjoyGetDevCapsA}
//extern "C" NAKED UINT  __declspec(dllexport) joyGetNumDevs(UINT uJoyID, LPJOYCAPS pjc, UINT cbjc) {  __asm jmp dword ptr   pjoyGetNumDevs}
#endif
