...
#define MAX_JS_CH	12
#define	NUM_AUDIO_BUFFS	64 /* Version 3.3.4 - Vista compatability */
#ifdef _DEBUG
#define BASEPRODUCT	  "SPP3.3.3"
#else
...
static WAVEHDR      *waveBuf[NUM_AUDIO_BUFFS];      // Array of poiters to audio buffers /* Version 3.3.4 - Vista compatability */
...
static DWORD ListenerTread;
//---------------------------------------------------------------------------

extern void StartPropo(void);
extern void RestartPropo(void);
