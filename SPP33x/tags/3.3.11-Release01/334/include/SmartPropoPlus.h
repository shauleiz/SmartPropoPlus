...
#define	VER_DLL		0x00030304 /* DLL File Version */
#define	VER_GUI		0x00030304 /* GUI File Version */
...
#define	DEVICE_CHANGED		"winmm_devicechange"
...
void SetSelectedMixerIndex(const int i);
int GetSelectedMixerIndex();
