========================================================================
    STATIC LIBRARY : FilterIf Project Overview
========================================================================

AppWizard has created this FilterIf library project for you. 
This file contains a summary of what you will find in each of the files that
make up your FilterIf application.
...
StdAfx.h, StdAfx.cpp
    ...
    named FilterIf.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "FilterIf.rc" and a "FilterIf.h" that 
