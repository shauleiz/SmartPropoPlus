...
public:
	...
	public:
		...
		public:
			...
			int GetInputLineVolumeValue(int i);
			const char * GetName();
			CMixerDevice();
		...
		protected:
			...
			bool m_ValidMixerDevice;// This variable is TRUE only if the object contains a valid mixer device
			int  m_WaveInID; // ID of the Wave In device that corresponds to this mixer device
	public:
	...
	public:
		...
		int GetMixerDeviceID(char *mixer);
